...
console.log(hasSumPair([2, 3, 4, 6], 7)); // Output: [0, 2] (2 + 4 = 6)
console.log(hasSumPair([2, 5, 7, 11, 15], 9)); // Output: [0, 1] (2 + 7 = 9)
console.log(hasSumPair([3, 3], 6)); // Output: [0, 1] (3 + 3 = 6)
console.log(hasSumPair([-1, 0, 3, 6, 8], 7)); // Output: [2, 4] (3 + 4 = 7)
